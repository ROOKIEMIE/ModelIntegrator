...
var schemaStatements = []string{
	...
	`CREATE TABLE IF NOT EXISTS runtime_instances (
		...
		precheck_gating INTEGER NOT NULL DEFAULT 0,
		precheck_reasons_json TEXT NOT NULL DEFAULT '[]',
		last_precheck_task_id TEXT NOT NULL DEFAULT '',
		last_precheck_at TEXT NOT NULL DEFAULT '',
		precheck_result_json TEXT NOT NULL DEFAULT '{}',
		precheck_summary_json TEXT NOT NULL DEFAULT '{}',
		...
		gating_status TEXT NOT NULL DEFAULT 'unknown',
		gating_allowed INTEGER NOT NULL DEFAULT 0,
		gating_reasons_json TEXT NOT NULL DEFAULT '[]',
		gating_summary_json TEXT NOT NULL DEFAULT '{}',
		last_lifecycle_plan_json TEXT NOT NULL DEFAULT '{}',
		created_at TEXT NOT NULL DEFAULT '',
		updated_at TEXT NOT NULL DEFAULT '',
		FOREIGN KEY(model_id) REFERENCES models(id) ON DELETE CASCADE,
